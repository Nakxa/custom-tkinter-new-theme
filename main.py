...
customtkinter.set_appearance_mode("Dark")  # Use Dark mode to match the theme
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # configure window
        self.title("CustomTkinter with Custom Theme")
        ...
        self.main_button_1 = customtkinter.CTkButton(master=self, fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"), text="CTkButton")
